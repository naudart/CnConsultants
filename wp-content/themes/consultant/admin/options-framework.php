...
function optionsframework_page() {
	...
	?>
	 ...
	 <div id="go_help">
            <p><b><?php _e('Need Help:', 'consultant'); ?></b> <a href="<?php echo esc_url( __( 'http://antthemes.com/?page_id=56', 'consultant' ) ); ?>" target="blank"><?php _e('Support Forum', 'consultant'); ?></a></p>
        </div>	
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!' , 'consultant' ) ); ?>' );" />
            <div class="clear"></div>
			
	 <div id="go_pro">
            <h1><?php _e('Go for Pro Version!', 'consultant'); ?></h1>
            <p><?php _e('This is a free version of consultant. Get your own copy of professional version if you need to setup your theme with Unlimited homepage Slides , Full width page template, Forum support and much more. ', 'consultant'); ?><a href="<?php echo esc_url( __( 'http://antthemes.com/?page_id=215', 'consultant' ) ); ?>" target="blank"><?php _e('Click Here to Learn More Now', 'consultant'); ?></a> </p>
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options' , 'consultant' ),
