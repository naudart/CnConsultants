...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'consultant' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'consultant' ),
		'repeat-y'  => __( 'Repeat Vertically', 'consultant' ),
		'repeat'    => __( 'Repeat All', 'consultant' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'consultant' ),
		'top center'    => __( 'Top Center', 'consultant' ),
		'top right'     => __( 'Top Right', 'consultant' ),
		'center left'   => __( 'Middle Left', 'consultant' ),
		'center center' => __( 'Middle Center', 'consultant' ),
		'center right'  => __( 'Middle Right', 'consultant' ),
		'bottom left'   => __( 'Bottom Left', 'consultant' ),
		'bottom center' => __( 'Bottom Center', 'consultant' ),
		'bottom right'  => __( 'Bottom Right', 'consultant')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'consultant' ),
		'fixed'  => __( 'Fixed in Place', 'consultant')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'consultant' ),
		'italic'      => __( 'Italic', 'consultant' ),
		'bold'        => __( 'Bold', 'consultant' ),
		'bold italic' => __( 'Bold Italic', 'consultant' )
		);
